...
class MCMC_state {
	...
	void sample_sigma2();
	void calc_b(size_t j, const mcmc_data &dat1, const mcmc_data &dat2, const mcmc_data &dat3, \
				const ldmat_data &ldmat_dat1, const ldmat_data &ldmat_dat2, const ldmat_data &ldmat_dat3);

	void sample_assignment(size_t j, const mcmc_data &dat1, const mcmc_data &dat2, const mcmc_data &dat3,\
									 const ldmat_data &ldmat_dat1, const ldmat_data &ldmat_dat2, const ldmat_data &ldmat_dat3);
	...
	void sample_alpha();
	void sample_theta();
	void sample_beta(size_t j, const mcmc_data &dat1, const mcmc_data &dat2, const mcmc_data &dat3, \
